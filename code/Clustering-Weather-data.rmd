...
#euclid 7,7,5
#pearson
###Based on the data above comparing original seed result with the new seed it's clear for all year the SSE has improved(value decreased) slightly with metric euclidean denoting the new center was slightly better while for pearson metric it has not improved much for all the year except 2009 (out of 2007-9)
